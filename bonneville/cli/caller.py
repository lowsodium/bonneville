...
from bonneville.log import LOG_LEVELS
...
class Caller(object):
    ...
    def __init__(self, opts):
        ...
        try:
            self.minion = bonneville.minion.SMinion(opts)
    ...
    def call(self):
        ...
        try:
            ...
            try:
                with bonneville.utils.fopen(proc_fn, 'w+b') as fp_:
    ...
    def print_grains(self):
        ...
        '''
        grains = bonneville.loader.grains(self.opts)
        bonneville.output.display_output({'local': grains}, 'grains', self.opts)
