...
class BufferedReader(object):
    ...
    def __init__(self, path, max_in_mem=256 * 1024, chunk_size=32 * 1024,
        ...
        self.__path = path
        self.__file = bonneville.utils.fopen(self.__path, mode)
...
def _main():
    ...
    for fmultiplier in (1, 10, 50, 100, 800, 3200):
        ffile = bonneville.utils.fopen(tpath, 'w')
        while fmultiplier > 0:
            ffile.write(bonneville.utils.fopen(fpath).read())
            fmultiplier -= 1
