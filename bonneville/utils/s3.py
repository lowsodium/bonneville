...
import bonneville.utils.xmlutil as xml
...
def query(key, keyid, method='GET', params=None, headers=None,
    ...
    if method == 'PUT':
        if local_file:
            with bonneville.utils.fopen(local_file, 'r') as ifile:
                data = ifile.read()
            req = urllib.request.Request(url=requesturl, data=data)
    ...
    if local_file and method == 'GET':
        ...
        with bonneville.utils.fopen(local_file, 'w') as out:
            out.write(response)
