...
class MasterPillarUtil(object):
    ...
    compiled directly from bonneville.pillar.Pillar on the master to
    ...
    ** However, the minion grains are still possibly entirely
    ...
    Example use case:
        ...
        # my_runner.py
        tgt = 'web*'
        pillar_util = bonneville.utils.master.MasterPillarUtil(tgt, expr_form='glob', opts=__opts__)
    ...
    def _get_cached_minion_data(self, *minion_ids):
        ...
        try:
            for minion_id in minion_ids:
                if not bonneville.utils.verify.valid_id(self.opts, minion_id):
                    continue
    ...
    def _get_live_minion_grains(self, minion_ids):
        ...
        client = bonneville.client.LocalClient(self.opts['conf_file'])
        ret = client.cmd(
                       ','.join(minion_ids),
                        'grains.items',
    ...
    def _tgt_to_list(self):
        ...
        minion_ids = []
        ckminions = bonneville.utils.minions.CkMinions(self.opts)
    ...
    def get_minion_pillar(self):
        ...
        By default, this function tries hard to get the pillar data:
            ...
            - Use the minion grains to compile the pillar directly from the
                master using bonneville.pillar.Pillar
        '''
        minion_pillars = {}
        minion_grains = {}
        ...
        try:
            for minion_id in minion_ids:
                ...
                if ((clear_pillar and clear_grains) or
                    ...
                    with bonneville.utils.fopen(data_file, 'w+b') as fp_:
