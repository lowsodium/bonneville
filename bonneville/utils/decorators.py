...
def which(exe):
    '''
    Decorator wrapper for bonneville.utils.which
    '''
    def wrapper(function):
        def wrapped(*args, **kwargs):
            if bonneville.utils.which(exe) is None:
...
def which_bin(exes):
    '''
    Decorator wrapper for bonneville.utils.which_bin
    '''
    def wrapper(function):
        def wrapped(*args, **kwargs):
            if bonneville.utils.which_bin(exes) is None:
                raise CommandNotFoundError(
