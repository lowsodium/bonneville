...
class NonBlockingPopen(subprocess.Popen):
    ...
    #_stdin_logger_name_ = 'bonneville.utils.nb_popen.STDIN.PID-{pid}'
    _stdout_logger_name_ = 'bonneville.utils.nb_popen.STDOUT.PID-{pid}'
    _stderr_logger_name_ = 'bonneville.utils.nb_popen.STDERR.PID-{pid}'
