# -*- coding: utf-8 -*-
'''
This module provides the point of entry for client applications to interface to bonneville.
...
from bonneville.exceptions import SaltException, EauthAuthenticationError
...
class APIClient(object):
    ...
    def __init__(self, opts=None):
        ...
        self.opts = opts
        self.localClient = bonneville.client.LocalClient(self.opts['conf_file'])
        self.runnerClient = bonneville.runner.RunnerClient(self.opts)
        self.wheelClient = bonneville.wheel.Wheel(self.opts)
        self.resolver = bonneville.auth.Resolver(self.opts)
        self.event = bonneville.utils.event.SaltEvent('master', self.opts['sock_dir'])
    ...
    def signature(self, cmd):
        ...
        if client == 'minion':
            ...
            result = bonneville.utils.argspec_report(functions, module)
        return result
