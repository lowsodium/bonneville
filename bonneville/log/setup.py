...
'''
    ...
    logger instance uses our ``bonneville.log.setup.SaltLoggingClass``.
'''
...
# Let's define these custom logging levels before importing the bonneville.log.mixins
...
from bonneville.log.handlers import TemporaryLoggingHandler
from bonneville.log.mixins import LoggingMixInMeta, NewStyleClassMixIn
...
def setup_extended_logging(opts):
    ...
    providers = bonneville.loader.log_handlers(opts)
