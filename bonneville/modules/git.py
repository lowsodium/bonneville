...
def clone(cwd, repository, opts=None, user=None, identity=None):
    ...
    .. code-block:: bash
        ...
        salt '*' git.clone /path/to/repo git://github.com/saltstack/bonneville.git

        salt '*' git.clone /path/to/repo.git\\
                git://github.com/saltstack/bonneville.git '--bare --origin github'
...
def remote_set(cwd, name='origin', url=None, user=None):
    ...
    .. code-block:: bash
        ...
        salt '*' git.remote_set /path/to/repo remote_url=git@github.com:saltstack/bonneville.git
        salt '*' git.remote_set /path/to/repo origin git@github.com:saltstack/bonneville.git
    '''
