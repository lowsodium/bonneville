...
def delete(bucket, path=None, action=None, key=None, keyid=None,
    ...
    return bonneville.utils.s3.query(method='DELETE',
                               bucket=bucket,
                               path=path,
                               action=action,
                               key=key,
...
def get(bucket=None, path=None, return_bin=False, action=None,
    ...
    return bonneville.utils.s3.query(method='GET',
                               bucket=bucket,
                               path=path,
...
def head(bucket, path=None, key=None, keyid=None, service_url=None):
    ...
    return bonneville.utils.s3.query(method='HEAD',
                               bucket=bucket,
                               path=path,
                               key=key,
                               keyid=keyid,
...
def put(bucket, path=None, return_bin=False, action=None, local_file=None,
    ...
    return bonneville.utils.s3.query(method='PUT',
                               bucket=bucket,
                               path=path,
                               return_bin=return_bin,
                               local_file=local_file,
