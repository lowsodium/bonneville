...
def versions_information():
    ...
    '''
    return dict(bonneville.version.versions_information())
...
def versions_report():
    ...
    '''
    return '\n'.join(bonneville.version.versions_report())
...
def not_loaded():
    ...
    prov = providers()
    ret = set()
    loader = bonneville.loader._create_loader(__opts__, 'modules', 'module')
