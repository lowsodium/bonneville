...
def __virtual__():
    ...
    '''
    if bonneville.utils.which('facter'):
        return 'puppet'
    return False
...
def _check_puppet():
    ...
    bonneville.utils.check_or_die('puppet')
...
def _check_facter():
    ...
    '''
    bonneville.utils.check_or_die('facter')
...
def run(*args, **kwargs):
    ...
    puppet.kwargs.update(bonneville.utils.clean_kwargs(**kwargs))
