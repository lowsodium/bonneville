...
def add(name,
    ...
    '''
    kwargs = bonneville.utils.clean_kwargs(**kwargs)
    if bonneville.utils.is_true(kwargs.pop('system', False)):
    ...
    if not bonneville.utils.is_true(unique):
        cmd += '-o '
...
def delete(name, remove=False, force=False):
    ...
    '''
    if bonneville.utils.is_true(force):
