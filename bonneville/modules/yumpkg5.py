...
from bonneville.modules.yumpkg import (mod_repo, _parse_repo_file, list_repos,
...
# This is imported in bonneville.modules.pkg_resource._parse_pkg_meta. Don't change
...
def list_pkgs(versions_as_list=False, **kwargs):
    ...
    if bonneville.utils.is_true(kwargs.get('removed')):
        return {}
    ...
    if pkg_type == 'repository':
        ...
        for pkgname, version_num in pkg_params.items():
            if version_num is None:
                ...
                if not cver or bonneville.utils.compare_versions(ver1=version_num,
                                                           oper='>=',
                                                           ver2=cver):
