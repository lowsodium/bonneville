...
import tempfile  # do not remove. Used in bonneville.modules.file.__clean_tmp
...
from bonneville.modules.file import (check_hash,  # pylint: disable=W0611
...
def __virtual__():
    ...
    if bonneville.utils.is_windows():
        if HAS_WINDOWS_MODULES:
            ...
            return 'file'
        log.warn(bonneville.utils.required_modules_error(__file__, __doc__))
    return False
