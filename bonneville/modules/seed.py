...
def apply_(path, id_=None, config=None, approve_key=True, install=True):
    ...
    if res:
        ...
        minion_config = bonneville.config.minion_config(tmp_config)
